			...
			<div class="w3_agile_banner_top">
				<div class="agile_phone_mail">
					<ul>
						...
						<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:jnyadwera@yahoo.com">jnyadwera@yahoo.com</a></li>
					</ul>
				</div>
			</div>
...
<!-- about -->
	<div class="about-wthree">
			<h2 class="w3l_head w3l_head1">About Us</h2>
				...
				<div class="container">
					<p>
      Welcome to <span>NYUMBANI HOMES</span>, your trusted partner in 
      finding the perfect place to call home.
    </p>
    <p>
      We understand that a home is more than just four walls – it’s where comfort, security, 
      and memories are built. That’s why we are committed to connecting tenants with quality, 
      affordable, and well-maintained housing solutions.
    </p>
    <p>
      Whether you’re a student looking for convenient housing, a family searching for a safe 
      neighborhood, or a landlord seeking trusted tenants, we are here to make housing simple, 
      reliable, and stress-free.
    </p>
    <p>
      At <span>NYUMBANI HOMES</span>, we don’t just provide houses — 
