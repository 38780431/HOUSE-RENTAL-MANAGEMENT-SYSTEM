		...
		<div class="container">
			<div class="w3_agile_banner_top">
				<div class="agile_phone_mail">
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i>+(254) 758 946 742</li>
						<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:jnyadwera@yahoo.com">jnyadwera@yahoo.com</a>
<i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:japhethnyadwera@gmail.com">japhethnyadwera@gmail.com</a></li>
					</ul>
				</div>
			</div>
				...
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<li>
  <h3>Welcome to Nyumbani Homes</h3>
  <p>We provide affordable and modern housing solutions across Kenya. Find your dream home today.</p>
</li>
<li>
  <h3>Our Mission</h3>
  <p>To make home ownership accessible by offering flexible payment plans and reliable housing projects.</p>
</li>
<li>
  <h3>Our Vision</h3>
  <p>To become Kenya’s most trusted and innovative real estate company.</p>
</li>
<li>
  <h3>Why Choose Us?</h3>
  <p>Quality homes, affordable prices, and customer-focused services that make your journey to owning a home smooth.</p>
</li>
